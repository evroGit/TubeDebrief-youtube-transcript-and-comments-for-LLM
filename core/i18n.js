...
const UI_STRINGS = {
  ru: {
    ...
    statusDonePopup: (what) => `Готово: скопировано — ${what}. Откройте LLM.`,
  ...
  en: {
    ...
    statusDonePopup: (what) => `Done: copied ${what}. Open an LLM.`,
  ...
  de: {
    ...
    statusDonePopup: (what) => `Fertig: ${what} kopiert. Öffne eine LLM.`,
